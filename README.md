...
The main protocols using ORCHIDs, with dedicated IPv6 prefixes, are the Host Identity Protocol (HIP,
[RFC7401](https://datatracker.ietf.org/doc/html/rfc7401)) with 
the Host Identity Tag (HIT) generated through ORCHID and Drone Remote ID Protocol (DRIP,
[RFC9374](https://datatracker.ietf.org/doc/html/rfc9374)) with the 
DRIP Entity Tag (DET) as its ORCHID. More on ORCHIDs can be found 
in [RFC7343](https://datatracker.ietf.org/doc/html/rfc7343).
...
[DRIP Key Infrastructure (DKI)](https://datatracker.ietf.org/doc/html/draft-ietf-drip-dki/).
